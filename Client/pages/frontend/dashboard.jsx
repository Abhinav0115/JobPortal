                    ...
                    <div className="w-full h-screen pt-20 flex items-center justify-start flex-col">
                        <div className="flex bg-gray-100 flex-wrap items-center justify-center w-full py-2 px-2">
                            ...
                            <div
                                ...
                                className="py-2 cursor-pointer border-orange-600 border-b-2 px-2 w-60 h-32 rounded mx-2 my-2 bg-white flex items-center justify-center"
                            >
                                <GiSuitcase className="bg-gray-50 text-sky-900 rounded-full w-10 h-10" />
                            ...
                            >
                                <BsFillBookmarkStarFill className="bg-gray-50 text-sky-900 rounded-full w-10 h-10" />
                                <div className="flex  flex-col items-start mx-2 justify-start px-2 ">
                                    <p className="text-xl font-semibold">
                                        Save Jobs
                                    </p>
                                    <p className="text-lg font-semibold">
                                        {bookMarkJobData.length || 0}
                                    </p>
                                </div>
                            </div>
