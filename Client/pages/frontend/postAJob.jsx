            ...
            <div className='w-full  py-20 flex items-center  justify-center flex-col'>
                ...
                <form onSubmit={handleSubmit} className="sm:w-1/2 w-full px-4 mx-4  h-full" >
                    ...
                    <div className='w-full mb-4  flex flex-col items-start justify-center'>
                        ...
                        <textarea onChange={(e) => setFormData({ ...formData, description: e.target.value })} onResize={"none"} type="text" id='description' className='w-full py-2 px-3 mb-2 border border-orange-600 rounded' placeholder='Enter description of job' />
                        {
                    ...
                    <button type="submit" className='w-full py-2 rounded bg-sky-900 text-white font-semibold tracking-widest'>Submit</button>
                </form>
            </div>
            <ToastContainer />
        </>
