...
export default function ApplyJob() {
    ...
    const handleSubmit = async (e) => {
        ...
        await UploadFile(file,'resume').then(res => form.append("cv", res));
    ...
    return (
        <>
            ...
            <div className="w-full  py-20 flex items-center  justify-center flex-col">
                <h1 className="text-xl mt-4 uppercase tracking-widest border-b-2 border-b-orange-600 py-2 font-semibold mb-8 md:text-2xl lg:text-4xl">
                    Enter Your Info
                </h1>
                <form
                ...
                >
                    ...
                    <div className="w-full mb-4  flex flex-col items-start justify-center">
                        ...
                        />
                        {error.cv && (
                            <p className="text-sm text-red-500">{error.cv}</p>
                        )}
                    </div>

                    <button
                        type="submit"
                        className="w-full py-2 rounded bg-sky-900 text-white font-semibold tracking-widest"
                    >
                        Submit
                    </button>
                </form>
