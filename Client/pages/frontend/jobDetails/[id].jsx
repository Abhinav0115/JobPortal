            ...
            {isLoading ? (
                ...
                <>
                    ...
                    <div className="w-full  py-20 flex items-center md:px-8 px-2  justify-center flex-col  ">
                        <h1 className="px-4 mx-2 my-6 mb-10 py-2 uppercase tracking-wider border-b-2 border-b-orange-600 text-3xl font-semibold">
                            <h1 className="text-3xl">Job Details</h1>
                        </h1>
                        <div className="flex items-center  justify-center px-4 w-full py-10">
                            <div className="flex w-full px-8 md:px-0  items-start md:flex-row flex-col md:justify-between justify-center">
                                <div className="flex mb-1 items-center justify-center">
                                    <Image
                                        src={JobDetails?.user?.profilePic || `https://ui-avatars.com/api/?name=${JobDetails?.user?.name}`}
                                        alt="no-image"
                                    ...
                                    <div className="px-4 mx-2 flex flex-col items-start justify-center">
                                        <p className="font-semibold text-base mb-1  capitalize">
                                            {JobDetails?.title}{" "}
                                        </p>
                                ...
                                <div className="grid lg:grid-cols-3 grid-cols-1">
                                    <div className="md:px-4  mb-1 px-2 md:mx-2 flex flex-col items-start justify-center">
                                        <div className="flex items-center justify-center mb-1">
                                            <FaUserAstronaut className="text-xs font-semibold text-sky-900" />
                                        ...
                                        <div className="flex items-center justify-center mb-1">
                                            <MdEmail className="text-xs font-semibold text-sky-900" />
                                            <p className="font-semibold text-base mx-1">
                                                Email:
                                            </p>
                                    ...
                                    <div className="md:px-4 mb-1 px-2 md:mx-2 flex flex-col items-start justify-center">
                                        <div className="flex items-center justify-center mb-1">
                                            <GoLocation className="text-xs font-semibold text-sky-900" />
                                            <p className="font-semibold text-base mx-1">
                                                Location{" "}
                                            </p>
                                        ...
                                        <div className="flex items-center justify-center mb-1">
                                            <MdCategory className="text-xs font-semibold text-sky-900" />
                                            <p className="font-semibold text-base mx-1">
                                                Category{" "}
                                            </p>
                                    ...
                                    <div className="md:px-4 mb-1 px-2 md:mx-2 flex flex-col items-start justify-center">
                                        <div className="flex items-center justify-center mb-1">
                                            <BsBriefcaseFill className="text-xs font-semibold text-sky-900" />
                                            <p className="font-semibold text-base mx-1">
                                                Job Type{" "}
                                            </p>
                                            <p className="text-sm text-gray-800 mx-1 capitalize">
                                        ...
                                        <div className="flex items-center justify-center mb-1">
                                            <AiOutlineDollarCircle className="text-xs font-semibold text-sky-900" />
                                            <p className="font-semibold text-base mx-1">
                                                Salary{" "}
                                            </p>
                                            <p className=" text-sm text-gray-800 mx-1">
                                    ...
                                    {JobDetails?.user?.email === user?.email ? (
                                        ...
                                        <div className="flex items-center justify-center  ">
                                            <BsFillBookmarkCheckFill
                                                ...
                                                className="text-sky-900 text-4xl cursor-pointer  mx-2"
                                            />
                                            <button
                                                onClick={handleApply}
                                                className="md:px-6 md:py-3 px-3 py-2 mt-2 md:mt-0 bg-orange-500 rounded text-base tracking-widest uppercase transition-all duration-700 hover:bg-orange-900 text-white  "
                                            >
                                                Apply Position
                                            </button>
                                        </div>
                        ...
                        <div className="w-full md:px-4 py-2 flex items-center md:items-start md:flex-row flex-col justify-start md:justify-center">
                            ...
                            <div className="md:w-4/12 w-full py-8 px-4 md:px-10">
                                ...
                                <div className="flex items-center justify-start mb-3">
                                    <RiUserSearchFill className="text-base font-semibold text-sky-900" />
                                    <p className="font-semibold text-base mx-1">
                                        Total Vacancies{" "}
                                    </p>
                                    <p className=" text-sm text-gray-800 mx-1">
                                ...
                                <div className="flex items-center justify-start mb-3">
                                    <BsFillCalendar2DateFill className="text-base font-semibold text-sky-900" />
                                    <p className="font-semibold text-base mx-1">
                                        Dead Line
                                    </p>
                                    <p className=" text-sm text-gray-800 mx-1">
                                        {new Date(
                                            `${JobDetails?.job_deadline}`
                                        ).toLocaleDateString("en-GB")}
                                    </p>
                                </div>
                                <div className="flex items-center justify-start mb-3">
                                    <HiOutlineStar className="text-base font-semibold text-sky-900" />
                                    <p className="font-semibold text-base mx-1">
                                        Experience Required
                                    </p>
                                    <p className=" text-sm text-gray-800 mx-1 capitalize">
                                            ...
                                            >
                                                <div className="mb-4 flex px-4 flex-col md:flex-row items-center justify-start py-2 ">
                                                    ...
                                                    <div className="flex flex-col w-full mx-2 px-2">
                                                        <h1 className="text-base md:text-left text-center  md:text-2xl font-semibold  capitalize">
                                                            {item?.title}
                                                        </h1>
                                                        <p className="text-xs md:text-left text-center sm:text-sm md:text-base text-gray-800  capitalize">
                                                            {item?.company}
                                                        </p>
                                                    </div>
                                                </div>
                                                <div className="flex flex-col px-1 md:px-4 py-6 items-start justify-center">
                                                    <div className="flex px-1 md:px-4 items-center justify-start mb-2">
                                                        <BsBriefcaseFill className="text-base font-semibold text-sky-900" />
                                                    ...
                                                    <div className="flex px-1 md:px-4 items-center justify-center mb-2">
                                                        <AiOutlineDollarCircle className="text-base font-semibold text-sky-900" />
                                                        <p className="font-semibold text-xs md:text-base mx-1">
                                                            Salary{" "}
                                                        </p>
                                                        <p className=" text-sm text-gray-800 mx-1">
                                                ...
                                                <button
                                                    onClick={() =>
                                                        router.push(
                                                            `/frontend/jobDetails/${item?._id}`
                                                        )
                                                    }
                                                    className="my-2 py-2 px-4  border border-orange-600 uppercase  rounded flex items-center justify-center transition-all duration-700 hover:bg-sky-900 hover:text-white text-sky-900 font-semibold"
                                                >
                                                    View Detail
