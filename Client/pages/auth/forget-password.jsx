    ...
    return (
        <>
            ...
            <section className=" text-center">
                <div className="flex flex-col items-center justify-center px-6 py-8 mt-8 mx-auto h-screen lg:py-0">
                    <div className="w-full p-6 bg-white rounded-2xl dark:border-2 shadow-lg  md:mt-0 sm:max-w-md  sm:p-8">
