    ...
    return (
        <>
            <Head>
                ...
                <meta
                    name="description"
                    content="A Job Portal for OPJU Campus Placements."
                />
                <meta
                    name="viewport"
                ...
                <link
                    rel="canonical"
                    // href="https://job-portal-teal.vercel.app/"
                />
                <meta name="author" content="OPJU" />
                <meta
                    property="og:title"
                    content="Find Your Dream Job | Job Portal - OPJU"
                />
                <meta
                    name="twitter:title"
                    content="Find Your Dream Job | Job Portal - OPJU"
            ...
            {isLoading ? (
                ...
                <>
                    <NavBar />
                    <div className="w-full mt-24  text-black">
                        <Intro />
                    </div>
                </>
            )}
